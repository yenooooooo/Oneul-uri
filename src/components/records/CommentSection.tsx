    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2 items-center">
        ...
        <input
          ...
          className="flex-1 bg-cream-dark rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-coral-300"
        />
        <button
          onClick={handleSend}
          disabled={!input.trim()}
        ...
        {editing ? (
          <div className="flex gap-1.5 mt-1">
            <input
              ...
              className="flex-1 bg-cream-dark rounded-lg px-3 py-1.5 text-sm focus:outline-none"
              autoFocus
            />
